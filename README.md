...
En cada carpeta (unidad) podrás encontrar:
- **Explicaciones Teóricas**: Resumen de los métodos matemáticos abordados.
- **Implementaciones en Código**: Scripts en Python que aplican los algoritmos estudiados, acompañados de casos de prueba y simulaciones.
- **Resolución Analítica**: Documentación y problemarios resueltos paso a paso para comprobar los resultados de la computadora.
...
---
<div align="center">
  <small>Desarrollado durante el 4to Semestre.</small>
</div>